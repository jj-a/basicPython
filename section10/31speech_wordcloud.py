...
text = ""
with open("section10/res/제100주년삼일절기념사.txt", "r", encoding="utf-8") as f:
    text = f.read()
...
wordcloud = WordCloud(width=1200, height=800, scale=3.0, stopwords=ignore,
                      ...
                      mask=img_array, background_color="#ffffff"  # 배경이미지 관련 옵션
                      )
...
wordcloud.to_file("section10/31speach_wordcloud.png")  # 크기는 scale에서 조정가능
